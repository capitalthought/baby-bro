...
This will start baby-bro's monitor in the background.  To see the monitor's output in the console, add the -t flag.
...
That's it.  You can add as many projects to your config as you like.  
...
== LICENSE:
  ...
  you may not any part of this software or its source code except 
